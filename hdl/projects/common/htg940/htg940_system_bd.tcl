...
create_bd_port -dir O ddr4_init_calib_complete
...
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.DDR4_TimePeriod 1250
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.DDR4_InputClockPeriod 5000
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.DDR4_CLKOUT0_DIVIDE 7
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.DDR4_MemoryType SODIMMs
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.DDR4_MemoryPart MTA8ATF51264HZ-2G1
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.DDR4_CasLatency 12
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.DDR4_CasWriteLatency 11
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.DDR4_AxiAddressWidth 32
ad_ip_parameter axi_ddr_cntrl CONFIG.C0.BANK_GROUP_WIDTH 2
...
ad_ip_parameter axi_ddr_cntrl CONFIG.ADDN_UI_CLKOUT3_FREQ_HZ 350
ad_ip_parameter axi_ddr_cntrl CONFIG.ADDN_UI_CLKOUT4_FREQ_HZ 175
...
ad_ip_parameter sys_ethernet_clkgen CONFIG.CLKOUT2_USED true
ad_ip_parameter sys_ethernet_clkgen CONFIG.CLKOUT1_REQUESTED_OUT_FREQ 125.000
ad_ip_parameter sys_ethernet_clkgen CONFIG.CLKOUT2_REQUESTED_OUT_FREQ 333.333
ad_ip_parameter sys_ethernet_clkgen CONFIG.MMCM_DIVCLK_DIVIDE 1
ad_ip_parameter sys_ethernet_clkgen CONFIG.MMCM_CLKFBOUT_MULT_F 5.000
ad_ip_parameter sys_ethernet_clkgen CONFIG.MMCM_CLKOUT0_DIVIDE_F 8.000
ad_ip_parameter sys_ethernet_clkgen CONFIG.MMCM_CLKOUT1_DIVIDE 3
ad_ip_parameter sys_ethernet_clkgen CONFIG.NUM_OUT_CLKS 2
ad_ip_parameter sys_ethernet_clkgen CONFIG.CLKOUT1_JITTER 107.523
ad_ip_parameter sys_ethernet_clkgen CONFIG.CLKOUT1_PHASE_ERROR 89.971
ad_ip_parameter sys_ethernet_clkgen CONFIG.CLKOUT2_JITTER 88.896
ad_ip_parameter sys_ethernet_clkgen CONFIG.CLKOUT2_PHASE_ERROR 89.971

ad_ip_instance axi_ethernet axi_ethernet_0
ad_ip_parameter axi_ethernet_0 CONFIG.PHY_TYPE RGMII
...
ad_connect ddr4_init_calib_complete axi_ddr_cntrl/c0_init_calib_complete
...
ad_connect axi_ddr_cntrl/c0_ddr4_ui_clk_sync_rst sys_350m_rstgen/ext_reset_in
...
ad_connect sys_350m_clk axi_ddr_cntrl/addn_ui_clkout3
...
set sys_iodelay_clk  [get_bd_nets sys_350m_clk]
...
set sys_iodelay_reset     [get_bd_nets sys_350m_reset]
set sys_iodelay_resetn    [get_bd_nets sys_350m_resetn]
...
ad_connect  rgmii axi_ethernet_0/rgmii
ad_connect  mdio axi_ethernet_0/mdio
ad_connect  phy_rst_n axi_ethernet_0/phy_rst_n

ad_connect  sys_200m_reset sys_ethernet_clkgen/reset
ad_connect  sys_200m_clk sys_ethernet_clkgen/clk_in1
ad_connect  sys_ethernet_clkgen/clk_out1 axi_ethernet_0/gtx_clk
ad_connect  sys_ethernet_clkgen/clk_out2 axi_ethernet_0/ref_clk
